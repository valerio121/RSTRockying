    ...
    <div class="container-fluid" style="padding: 0px;">
        ...
        <form id="form1" runat="server" class="needs-validation" novalidate style="padding: 5px;">
            ...
            <div class="alert alert-success fixed-bottom" id="message" role="alert" style="margin-top: 20px;">
                Thanks for signing up with Rockying, expect an email with activation link from <strong><%= Rockying.Models.Utility.NewsletterEmail %></strong>. 
                Please go to that link to activate your subscription. You may have to check the "SPAM" folder of your mail account for the email.
            </div>
            <script>
