            ...
            <div class="form-horizontal">
                ...
                <div class="mb-2">
                    <label class="form-label" for="<%: PasswordTextBox.ClientID %>">
                        Password</label>
                    <asp:TextBox CssClass="form-control" ID="PasswordTextBox" MaxLength="40" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                        ControlToValidate="PasswordTextBox" CssClass="text-danger" Display="Dynamic"
                ...
                <div class="mb-2">
                    <label class="form-label" for="<%: NameTextBox.ClientID %>">
                        Name</label>
                    <asp:TextBox ID="NameTextBox" MaxLength="200" runat="server" CssClass="form-control"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                        ControlToValidate="NameTextBox" CssClass="text-danger" Display="Dynamic"
                        ErrorMessage="Required" SetFocusOnError="True" ValidationGroup="MemberGrp"></asp:RequiredFieldValidator>
                </div>
                <div class="mb-2">
                    <label class="form-label" for="<%: LastNameTextBox.ClientID %>">
                        Last Name</label>
                    <asp:TextBox MaxLength="200" ID="LastNameTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="mb-2">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Display="Static"
                                        ControlToValidate="YearDropDown" CssClass="text-danger" ValidationGroup="MemberGrp"
                                ...
                                <div class="col">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" Display="Static"
                                        ControlToValidate="MonthDropDown" CssClass="text-danger" ValidationGroup="MemberGrp"
                                        ErrorMessage="*"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" Display="Static"
                                        ControlToValidate="DateDropDown" CssClass="text-danger" ValidationGroup="MemberGrp"
                                        ErrorMessage="*"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </ContentTemplate>
                ...
                <div class="mb-2">
                    <label class="form-label" for="<%: StatusDropDown.ClientID %>">
                        Status</label>
                    <asp:DropDownList CssClass="form-control" ID="StatusDropDown" runat="server">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                        ControlToValidate="StatusDropDown" CssClass="text-danger" Display="Dynamic"
                        ErrorMessage="Required" SetFocusOnError="True" ValidationGroup="MemberGrp"></asp:RequiredFieldValidator>
                </div>
                <div class="mb-2">
                    <label class="form-label" for="<%: MemberTypeDropDown.ClientID %>">
                        Member Type</label>
                    <asp:DropDownList ID="MemberTypeDropDown" runat="server" CssClass="form-control">
                        <asp:ListItem Value="">--Select--</asp:ListItem>
                        <asp:ListItem Value="2">Author</asp:ListItem>
                        <asp:ListItem Value="3">Member</asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                        ControlToValidate="MemberTypeDropDown" CssClass="text-danger" Display="Dynamic"
                        ErrorMessage="Required" SetFocusOnError="True" ValidationGroup="MemberGrp"></asp:RequiredFieldValidator>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2">
                    ...
                    <asp:Button ID="SendActivationEmailButton" runat="server" Text="Send Activation Email" CssClass="btn btn-info mx-5"
                        CausesValidation="false" OnClick="SendActivationEmailButton_Click" />
                </div>
            </div>
        </div>
    </div>
