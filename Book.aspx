...
<asp:Content ID="Content4" ContentPlaceHolderID="BottomContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function generateWithT2() {
            ...
            var txtHeight = canvas.height - 160;
            context.globalAlpha = 0.5;
            context.fillStyle = "#000000";
            ...
            context.textAlign = 'center';
            context.textBaseline = 'middle';
            context.fillText("Reading Now", canvas.width / 2, txtHeight + 35);
            ...
            context.fillRect(10, txtHeight + 100, progress, 20);
            context.fillStyle = '#495057';
            context.fillRect(10 + progress, txtHeight + 100, (canvas.width - 20) - progress, 20);
            ...
            context.fillStyle = '#ffffff';
            context.font = '18px Arial';
            context.fillText("I read " + avgspeed + " pages per day :)", canvas.width / 2, txtHeight + 140);
        }
        ...
        $(document).ready(function () {
            ...
            else if (hash === "#<%= Utility.ShareProgressHash%>") {
                $("#shareprogressbtn").click();
            }
            else if (hash === "#<%= Utility.ShareQouteHash%>") {
                $("#shareqoutebtn").click();
            }
        });
